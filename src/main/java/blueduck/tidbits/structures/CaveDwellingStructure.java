package blueduck.tidbits.structures;
...
public class CaveDwellingStructure extends Structure<NoFeatureConfig> {
    public CaveDwellingStructure(Codec<NoFeatureConfig> codec) {
        super(codec);
    }
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return CaveDwellingStructure.Start::new;
    }
...
//    }
    ...
    public static int getYPosForStructure(int chunkX, int chunkY, ChunkGenerator generatorIn) {
        ...
        int k = (chunkX << 4) + 7;
        int l = (chunkY << 4) + 7;
        int i1 = generatorIn.getBaseHeight(k, l, Heightmap.Type.WORLD_SURFACE_WG);
        int j1 = generatorIn.getBaseHeight(k, l + j, Heightmap.Type.WORLD_SURFACE_WG);
        int k1 = generatorIn.getBaseHeight(k + i, l, Heightmap.Type.WORLD_SURFACE_WG);
        int l1 = generatorIn.getBaseHeight(k + i, l + j, Heightmap.Type.WORLD_SURFACE_WG);
    ...
    public static class Start extends StructureStart<NoFeatureConfig> {
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            int offset = (random.nextInt(30) + 20) * -1;

            this.pieces.forEach(piece -> piece.move(0,  offset, 0));
            this.pieces.forEach(piece -> piece.getBoundingBox().y0 += offset);
