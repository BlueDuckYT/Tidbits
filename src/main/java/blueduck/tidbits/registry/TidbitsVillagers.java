...
public class TidbitsVillagers {
    ...
    public static void addHouses() {
        ...
        if (Tidbits.CONFIG.LUMBERJACK.get()) {
            addToPool(new ResourceLocation("village/plains/houses"), new ResourceLocation("tidbits:village/lumberjack_plains"), 20);
            addToPool(new ResourceLocation("village/snowy/houses"), new ResourceLocation("tidbits:village/lumberjack_snowy"), 20);
            addToPool(new ResourceLocation("village/taiga/houses"), new ResourceLocation("tidbits:village/lumberjack_taiga"), 20);
